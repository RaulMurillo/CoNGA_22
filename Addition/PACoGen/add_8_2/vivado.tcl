...
####
# read_verilog top.v
# read_vhdl fp_mult_expr_FU_32_32_400.vhdl
# read_vhdl fp_plus_expr_FU_32_32_300.vhdl
# read_vhdl top.vhd
####
...
#   puts $ofile_sdc "set_property HD.PARTPIN_LOCS INT_R_X0Y0 \[get_ports in1\[0\]\]"
#   puts $ofile_sdc "set_property HD.PARTPIN_LOCS INT_R_X0Y0 \[get_ports in2\[0\]\]"
#   # puts $ofile_sdc "set_property HD.PARTPIN_LOCS INT_R_X0Y0 \[get_ports in1\[0\]\]"
#   # puts $ofile_sdc "set_property HD.PARTPIN_LOCS INT_R_X0Y0 \[get_ports in2\[0\]\]"
#   close $ofile_sdc
# }
